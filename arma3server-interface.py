...
STOP_ARMA3HC3 = 'sudo systemctl stop arma3hc3.service'
    ...
    for root, dirs, files in os.walk(directory):
        for sub_dir in dirs:
            if sub_dir.startswith('@'):
                addon_folders.append(os.path.join(root, sub_dir))
...
def select_mods(query_string):
    ...
    elif query_dict['modpack'] == 'minimal':
        addon_folders.extend(get_addon_folders('/home/arma3server/serverfiles/mods.minimal/'))
    ...
    elif query_dict['modpack'] == 'daa':
        addon_folders.extend(get_addon_folders('/home/arma3server/serverfiles/mods.daa/'))
        enable_server_mods = False
    ...
    if 'rf' in query_dict:
        addon_folders.append('rf')

    if 'ef' in query_dict:
        addon_folders.append('ef')
